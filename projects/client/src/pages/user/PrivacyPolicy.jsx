    ...
    <div>
      <div>
        ...
        <div className="min-h-screen mx-6 space-y-4 md:space-y-8 lg:space-y-8 lg:mx-32">
          <div className="my-4 space-y-3 text-justify md:space-y-3 lg:space-y-3">
            <h1 className="font-bold">Privacy Policy for furnifor</h1>
            <p>
              At furnifor, accessible from www.furnifor.com, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by furnifor and how we use it.
            </p>
            <p>
              If you have additional questions or require more information about
              our Privacy Policy, do not hesitate to contact us.
            </p>
            <h2 className="font-semibold">Log Files</h2>
            <p>
              furnifor follows a standard procedure of using log files. These
            ...
            <h2 className="font-semibold">Cookies and Web Beacons</h2>
            <p>
              Like any other website, furnifor uses "cookies". These cookies are
            ...
            <h2 className="font-semibold">Privacy Policies</h2>
            <p>
              You may consult this list to find the Privacy Policy for each of
              the advertising partners of furnifor.
            </p>
            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on furnifor, which
            ...
            <p>
              Note that furnifor has no access to or control over these cookies
              that are used by third-party advertisers.
            </p>
            <h2 className="font-semibold">Third Party Privacy Policies</h2>
            <p>
              furnifor's Privacy Policy does not apply to other advertisers or
            ...
            <p>
              furnifor does not knowingly collect any Personal Identifiable
            ...
            <h2 className="font-semibold">Online Privacy Policy Only</h2>
            <p>
              This Privacy Policy applies only to our online activities and is
              valid for visitors to our website with regards to the information
              that they shared and/or collect in furnifor. This policy is not
